...
type packetPool struct {
	c               *astikit.Closer
	cumulativeStats *packetPoolCumulativeStats
...
func newPacketPool() *packetPool {
	return &packetPool{cumulativeStats: &packetPoolCumulativeStats{}}
}
...
func (pp *packetPool) get() (pkt *astiav.Packet) {
	...
	if len(pp.ps) == 0 {
		...
		atomic.AddUint64(&pp.cumulativeStats.allocatedPackets, 1)
	...
	return []astikit.DeltaStat{
		{
			...
			Valuer: astikit.NewAtomicUint64CumulativeDeltaStat(&pp.cumulativeStats.allocatedPackets),
		},
	}
}
