...
type framePool struct {
	c               *astikit.Closer
	cumulativeStats *framePoolCumulativeStats
	fs              []*astiav.Frame
...
func newFramePool() *framePool {
	return &framePool{cumulativeStats: &framePoolCumulativeStats{}}
}
...
func (fp *framePool) get() (f *astiav.Frame) {
	...
	if len(fp.fs) == 0 {
		...
		atomic.AddUint64(&fp.cumulativeStats.allocatedFrames, 1)
	...
	return []astikit.DeltaStat{
		{
			...
			Valuer: astikit.NewAtomicUint64CumulativeDeltaStat(&fp.cumulativeStats.allocatedFrames),
		},
	}
}
